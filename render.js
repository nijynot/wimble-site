  ...
  return (
    <div className="Header">
      ...
      <div className="Header-intro">
        ...
        <animated.div style={animateHeader} className="Header-mock">
          <img className="Header-app" src="assets/png/mac-window.png" />
...
function App() {
  ...
  const base64 = '';

  return (
    <div className="App">
      <Header />
      {/*<animated.div style={animateContent} className="App-content">
        <div className="Send">
          <h3>Send Grin using File, String or HTTP</h3>
        </div>
        <div className="Send-methods">
          <div className="Send-method">
            ...
            <div className="Send-method-description">
              By file
            </div>
          </div>
          <div className="Send-method">
